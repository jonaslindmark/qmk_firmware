 ...
 * |   =    |   1  |   2  |   3  |   4  |   5  |      |           |      |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | LCTL   |   Q  |   W  |   E  |   R  |   T  |      |           |      |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSpc  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   '    |
 * |--------+------+------+------+------+------| RAISE|           |      |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |  /   | RGUI   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      | LALT | ~L1  | Esc/RGUI|                                    |`/RCTL| Bspc | RALT |      |      |
 *   `-------------------------------------'                                    `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,         KC_Z,        KC_X,          KC_C,     KC_V,    KC_B,    MO(RAISE),           KC_NO,              KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
