 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LGUI  | LAlt |AltShf| Left | Right|                                       | RCtl | RAlt |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | Home |       | PgUp  | tmux |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LGUI,        KC_LALT,      MO(MDIA),  KC_GRAVE,KC_ESC,
        ...
        // right hand
             ...
             MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          M(M_TMUX),
                                  KC_RCTL,KC_RALT,KC_LBRC,KC_RBRC,          KC_FN1,
             KC_PGUP,M(M_PYDEB),
             KC_PGDN,
